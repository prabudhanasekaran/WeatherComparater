	...
	private ExtentReport() {
		...
		if(ReadPropertyFile.get("OverrideResults").equalsIgnoreCase("yes")) 
		{
			if(ReadPropertyFile.get("ResultPath").equals("")) 
			{
				...
				extentreportpath=Constants.PROJECTPATH+ReadPropertyFile.get("ResultPath")+"\\Test Report.html";
			}
		}
		else 
		{
			...
			{
				extentreportpath=Constants.PROJECTPATH+ReadPropertyFile.get("ResultPath")+"\\Test Report_"+currentDate+".html";
