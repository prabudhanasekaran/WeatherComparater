	...
	private void startBrowserForLocal() {
		...
		try {
			if(browser.equalsIgnoreCase("chrome")) {
				//WebDriverManager.chromedriver().setup();  //WebDriverManager sometimes wont work because of proxy issues
			...
			{
				//WebDriverManager.firefoxdriver().setup(); //WebDriverManager sometimes wont work because of proxy issues
